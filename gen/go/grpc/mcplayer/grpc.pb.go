...
func (x *GetGlobalSummaryRequest) Reset() {
	*x = GetGlobalSummaryRequest{}
	if protoimpl.UnsafeEnabled {
...
func (x *GetGlobalSummaryRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetGlobalSummaryRequest) ProtoMessage() {}

func (x *GetGlobalSummaryRequest) ProtoReflect() protoreflect.Message {
	mi := &file_mc_player_grpc_proto_msgTypes[23]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetGlobalSummaryRequest.ProtoReflect.Descriptor instead.
...
func (x *GetGlobalSummaryResponse) Reset() {
	*x = GetGlobalSummaryResponse{}
	if protoimpl.UnsafeEnabled {
...
func (x *GetGlobalSummaryResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetGlobalSummaryResponse) ProtoMessage() {}

func (x *GetGlobalSummaryResponse) ProtoReflect() protoreflect.Message {
	mi := &file_mc_player_grpc_proto_msgTypes[24]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetGlobalSummaryResponse.ProtoReflect.Descriptor instead.
func (*GetGlobalSummaryResponse) Descriptor() ([]byte, []int) {
	return file_mc_player_grpc_proto_rawDescGZIP(), []int{24}
}

func (x *GetGlobalSummaryResponse) GetOnlinePlayers() []*mcplayer.OnlinePlayer {
	if x != nil {
		return x.OnlinePlayers
	}
	return nil
...
func (x *GetFleetSummaryRequest) Reset() {
	*x = GetFleetSummaryRequest{}
	if protoimpl.UnsafeEnabled {
...
func (x *GetFleetSummaryRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetFleetSummaryRequest) ProtoMessage() {}

func (x *GetFleetSummaryRequest) ProtoReflect() protoreflect.Message {
	mi := &file_mc_player_grpc_proto_msgTypes[25]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetFleetSummaryRequest.ProtoReflect.Descriptor instead.
func (*GetFleetSummaryRequest) Descriptor() ([]byte, []int) {
	return file_mc_player_grpc_proto_rawDescGZIP(), []int{25}
}

func (x *GetFleetSummaryRequest) GetFleetName() string {
	if x != nil {
		return x.FleetName
	}
	return ""
...
func (x *GetFleetSummaryResponse) Reset() {
	*x = GetFleetSummaryResponse{}
	if protoimpl.UnsafeEnabled {
...
func (x *GetFleetSummaryResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetFleetSummaryResponse) ProtoMessage() {}

func (x *GetFleetSummaryResponse) ProtoReflect() protoreflect.Message {
	mi := &file_mc_player_grpc_proto_msgTypes[26]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetFleetSummaryResponse.ProtoReflect.Descriptor instead.
func (*GetFleetSummaryResponse) Descriptor() ([]byte, []int) {
	return file_mc_player_grpc_proto_rawDescGZIP(), []int{26}
}

func (x *GetFleetSummaryResponse) GetOnlinePlayers() []*mcplayer.OnlinePlayer {
	if x != nil {
		return x.OnlinePlayers
	}
	return nil
...
type GetServerSummaryRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *GetServerSummaryRequest) Reset() {
	*x = GetServerSummaryRequest{}
	if protoimpl.UnsafeEnabled {
...
func (x *GetServerSummaryRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetServerSummaryRequest) ProtoMessage() {}

func (x *GetServerSummaryRequest) ProtoReflect() protoreflect.Message {
	mi := &file_mc_player_grpc_proto_msgTypes[27]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetServerSummaryRequest.ProtoReflect.Descriptor instead.
func (*GetServerSummaryRequest) Descriptor() ([]byte, []int) {
	return file_mc_player_grpc_proto_rawDescGZIP(), []int{27}
}

func (x *GetServerSummaryRequest) GetServerId() string {
	if x != nil {
		return x.ServerId
	}
	return ""
...
type GetServerSummaryResponse struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *GetServerSummaryResponse) Reset() {
	*x = GetServerSummaryResponse{}
	if protoimpl.UnsafeEnabled {
...
func (x *GetServerSummaryResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetServerSummaryResponse) ProtoMessage() {}

func (x *GetServerSummaryResponse) ProtoReflect() protoreflect.Message {
	mi := &file_mc_player_grpc_proto_msgTypes[28]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetServerSummaryResponse.ProtoReflect.Descriptor instead.
func (*GetServerSummaryResponse) Descriptor() ([]byte, []int) {
	return file_mc_player_grpc_proto_rawDescGZIP(), []int{28}
}

func (x *GetServerSummaryResponse) GetOnlinePlayers() []*mcplayer.OnlinePlayer {
	if x != nil {
		return x.OnlinePlayers
	}
	return nil
...
var file_mc_player_grpc_proto_rawDesc = []byte{
	...
	,
	...
	0x4f, 0x6e, 0x6c, 0x69, 0x6e, 0x65, 0x50, 0x6c, 0x61, 0x79, 0x65, 0x72, 0x52, 0x0d, 0x6f, 0x6e,
	0x6c, 0x69, 0x6e, 0x65, 0x50, 0x6c, 0x61, 0x79, 0x65, 0x72, 0x73, 0x22, 0x36, 0x0a, 0x17, 0x47,
	0x65, 0x74, 0x53, 0x65, 0x72, 0x76, 0x65, 0x72, 0x53, 0x75, 0x6d, 0x6d, 0x61, 0x72, 0x79, 0x52,
	...
	,
	...
	0x12, 0x51, 0x0a, 0x0a, 0x47, 0x65, 0x74, 0x50, 0x6c, 0x61, 0x79, 0x65, 0x72, 0x73, 0x12, 0x1f,
	...
	,
	...
	,
	...
	0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x26, 0x2e, 0x65, 0x6d, 0x6f, 0x72, 0x74, 0x61, 0x6c,
	...
	,
	...
	0x2e, 0x47, 0x65, 0x74, 0x46, 0x6c, 0x65, 0x65, 0x74, 0x73, 0x50, 0x6c, 0x61, 0x79, 0x65, 0x72,
	0x43, 0x6f, 0x75, 0x6e, 0x74, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x61, 0x0a,
	0x10, 0x47, 0x65, 0x74, 0x47, 0x6c, 0x6f, 0x62, 0x61, 0x6c, 0x53, 0x75, 0x6d, 0x6d, 0x61, 0x72,
	0x79, 0x12, 0x25, 0x2e, 0x65, 0x6d, 0x6f, 0x72, 0x74, 0x61, 0x6c, 0x2e, 0x67, 0x72, 0x70, 0x63,
	0x2e, 0x47, 0x65, 0x74, 0x47, 0x6c, 0x6f, 0x62, 0x61, 0x6c, 0x53, 0x75, 0x6d, 0x6d, 0x61, 0x72,
	0x79, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x26, 0x2e, 0x65, 0x6d, 0x6f, 0x72, 0x74,
	...
	,
	...
	0x6e, 0x73, 0x65, 0x42, 0x65, 0x0a, 0x1d, 0x64, 0x65, 0x76, 0x2e, 0x65, 0x6d, 0x6f, 0x72, 0x74,
...
var file_mc_player_grpc_proto_msgTypes = make([]protoimpl.MessageInfo, 31)
var file_mc_player_grpc_proto_goTypes = []interface{}{
	...
	(*GetGlobalSummaryRequest)(nil),                  // 24: emortal.grpc.GetGlobalSummaryRequest
	(*GetGlobalSummaryResponse)(nil),                 // 25: emortal.grpc.GetGlobalSummaryResponse
	(*GetFleetSummaryRequest)(nil),                   // 26: emortal.grpc.GetFleetSummaryRequest
	(*GetFleetSummaryResponse)(nil),                  // 27: emortal.grpc.GetFleetSummaryResponse
	(*GetServerSummaryRequest)(nil),                  // 28: emortal.grpc.GetServerSummaryRequest
	(*GetServerSummaryResponse)(nil),                 // 29: emortal.grpc.GetServerSummaryResponse
	...
	(*mcplayer.McPlayer)(nil),                        // 32: emortal.model.McPlayer
	(*common.Pageable)(nil),                          // 33: emortal.model.Pageable
	(*common.PageData)(nil),                          // 34: emortal.model.PageData
	(*mcplayer.LoginSession)(nil),                    // 35: emortal.model.LoginSession
	(*mcplayer.OnlinePlayer)(nil),                    // 36: emortal.model.OnlinePlayer
	(*mcplayer.CurrentServer)(nil),                   // 37: emortal.model.CurrentServer
}
var file_mc_player_grpc_proto_depIdxs = []int32{
	32, // 0: emortal.grpc.GetPlayerResponse.player:type_name -> emortal.model.McPlayer
	32, // 1: emortal.grpc.GetPlayersResponse.players:type_name -> emortal.model.McPlayer
	32, // 2: emortal.grpc.GetPlayerByUsernameResponse.player:type_name -> emortal.model.McPlayer
	33, // 3: emortal.grpc.SearchPlayersByUsernameRequest.pageable:type_name -> emortal.model.Pageable
	...
	32, // 5: emortal.grpc.SearchPlayersByUsernameResponse.players:type_name -> emortal.model.McPlayer
	34, // 6: emortal.grpc.SearchPlayersByUsernameResponse.page_data:type_name -> emortal.model.PageData
	33, // 7: emortal.grpc.GetLoginSessionsRequest.pageable:type_name -> emortal.model.Pageable
	35, // 8: emortal.grpc.LoginSessionsResponse.sessions:type_name -> emortal.model.LoginSession
	34, // 9: emortal.grpc.LoginSessionsResponse.page_data:type_name -> emortal.model.PageData
	...
	36, // 11: emortal.grpc.GetServerPlayersResponse.online_players:type_name -> emortal.model.OnlinePlayer
	...
	36, // 13: emortal.grpc.GetGlobalSummaryResponse.online_players:type_name -> emortal.model.OnlinePlayer
	36, // 14: emortal.grpc.GetFleetSummaryResponse.online_players:type_name -> emortal.model.OnlinePlayer
	36, // 15: emortal.grpc.GetServerSummaryResponse.online_players:type_name -> emortal.model.OnlinePlayer
	37, // 16: emortal.grpc.GetPlayerServersResponse.PlayerServersEntry.value:type_name -> emortal.model.CurrentServer
	1,  // 17: emortal.grpc.McPlayer.GetPlayer:input_type -> emortal.grpc.GetPlayerRequest
	3,  // 18: emortal.grpc.McPlayer.GetPlayers:input_type -> emortal.grpc.GetPlayersRequest
	5,  // 19: emortal.grpc.McPlayer.GetPlayerByUsername:input_type -> emortal.grpc.PlayerUsernameRequest
	8,  // 20: emortal.grpc.McPlayer.SearchPlayersByUsername:input_type -> emortal.grpc.SearchPlayersByUsernameRequest
	10, // 21: emortal.grpc.McPlayer.GetLoginSessions:input_type -> emortal.grpc.GetLoginSessionsRequest
	12, // 22: emortal.grpc.McPlayer.GetStatTotalUniquePlayers:input_type -> emortal.grpc.GetStatTotalUniquePlayersRequest
	14, // 23: emortal.grpc.McPlayer.GetStatTotalPlaytime:input_type -> emortal.grpc.GetStatTotalPlaytimeRequest
	16, // 24: emortal.grpc.PlayerTracker.GetPlayerServers:input_type -> emortal.grpc.GetPlayerServersRequest
	18, // 25: emortal.grpc.PlayerTracker.GetServerPlayers:input_type -> emortal.grpc.GetServerPlayersRequest
	20, // 26: emortal.grpc.PlayerTracker.GetPlayerCount:input_type -> emortal.grpc.GetPlayerCountRequest
	22, // 27: emortal.grpc.PlayerTracker.GetFleetPlayerCounts:input_type -> emortal.grpc.GetFleetsPlayerCountRequest
	24, // 28: emortal.grpc.PlayerTracker.GetGlobalSummary:input_type -> emortal.grpc.GetGlobalSummaryRequest
	26, // 29: emortal.grpc.PlayerTracker.GetFleetSummary:input_type -> emortal.grpc.GetFleetSummaryRequest
	28, // 30: emortal.grpc.PlayerTracker.GetServerSummary:input_type -> emortal.grpc.GetServerSummaryRequest
	2,  // 31: emortal.grpc.McPlayer.GetPlayer:output_type -> emortal.grpc.GetPlayerResponse
	4,  // 32: emortal.grpc.McPlayer.GetPlayers:output_type -> emortal.grpc.GetPlayersResponse
	6,  // 33: emortal.grpc.McPlayer.GetPlayerByUsername:output_type -> emortal.grpc.GetPlayerByUsernameResponse
	9,  // 34: emortal.grpc.McPlayer.SearchPlayersByUsername:output_type -> emortal.grpc.SearchPlayersByUsernameResponse
	11, // 35: emortal.grpc.McPlayer.GetLoginSessions:output_type -> emortal.grpc.LoginSessionsResponse
	13, // 36: emortal.grpc.McPlayer.GetStatTotalUniquePlayers:output_type -> emortal.grpc.GetStatTotalUniquePlayersResponse
	15, // 37: emortal.grpc.McPlayer.GetStatTotalPlaytime:output_type -> emortal.grpc.GetStatTotalPlaytimeResponse
	17, // 38: emortal.grpc.PlayerTracker.GetPlayerServers:output_type -> emortal.grpc.GetPlayerServersResponse
	19, // 39: emortal.grpc.PlayerTracker.GetServerPlayers:output_type -> emortal.grpc.GetServerPlayersResponse
	21, // 40: emortal.grpc.PlayerTracker.GetPlayerCount:output_type -> emortal.grpc.GetPlayerCountResponse
	23, // 41: emortal.grpc.PlayerTracker.GetFleetPlayerCounts:output_type -> emortal.grpc.GetFleetsPlayerCountResponse
	25, // 42: emortal.grpc.PlayerTracker.GetGlobalSummary:output_type -> emortal.grpc.GetGlobalSummaryResponse
	27, // 43: emortal.grpc.PlayerTracker.GetFleetSummary:output_type -> emortal.grpc.GetFleetSummaryResponse
	29, // 44: emortal.grpc.PlayerTracker.GetServerSummary:output_type -> emortal.grpc.GetServerSummaryResponse
...
func file_mc_player_grpc_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_mc_player_grpc_proto_msgTypes[23].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*GetGlobalSummaryRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_mc_player_grpc_proto_msgTypes[24].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*GetGlobalSummaryResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_mc_player_grpc_proto_msgTypes[25].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*GetFleetSummaryRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_mc_player_grpc_proto_msgTypes[26].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*GetFleetSummaryResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_mc_player_grpc_proto_msgTypes[27].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*GetServerSummaryRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_mc_player_grpc_proto_msgTypes[28].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*GetServerSummaryResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
