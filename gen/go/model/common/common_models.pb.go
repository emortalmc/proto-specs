...
const file_common_models_proto_rawDesc = "" +
	"\n" +
	"\x13common_models.proto\x12\remortal.model\"D\n" +
	"\n" +
	"PlayerSkin\x12\x18\n" +
	"\atexture\x18\x01 \x01(\tR\atexture\x12\x1c\n" +
	"\tsignature\x18\x02 \x01(\tR\tsignature\"Q\n" +
	"\x11ConnectableServer\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12\x18\n" +
	"\aaddress\x18\x02 \x01(\tR\aaddress\x12\x12\n" +
	"\x04port\x18\x03 \x01(\rR\x04port\"@\n" +
	"\bPageable\x12\x12\n" +
	"\x04page\x18\x01 \x01(\x04R\x04page\x12\x17\n" +
	"\x04size\x18\x02 \x01(\x04H\x00R\x04size\x88\x01\x01B\a\n" +
	"\x05_size\">\n" +
	"\bSortable\x12\x14\n" +
	"\x05field\x18\x01 \x01(\tR\x05field\x12\x1c\n" +
	"\tascending\x18\x02 \x01(\bR\tascending\"z\n" +
	"\bPageData\x12\x12\n" +
	"\x04page\x18\x01 \x01(\x04R\x04page\x12\x12\n" +
	"\x04size\x18\x02 \x01(\x04R\x04size\x12%\n" +
	"\x0etotal_elements\x18\x03 \x01(\x04R\rtotalElements\x12\x1f\n" +
	"\vtotal_pages\x18\x04 \x01(\x04R\n" +
	"totalPagesBV\n" +
	"\x1cdev.emortal.api.model.commonP\x01Z4github.com/emortalmc/proto-specs/gen/go/model/commonb\x06proto3"
...
func file_common_models_proto_init() {
	...
	file_common_models_proto_msgTypes[2].OneofWrappers = []any{}
	type x struct{}
