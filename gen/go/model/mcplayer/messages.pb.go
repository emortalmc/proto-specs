...
type PlayerExperienceChangeMessage struct {
	...
	PreviousExperience int32  `protobuf:"varint,3,opt,name=previous_experience,json=previousExperience,proto3" json:"previous_experience,omitempty"`
	NewExperience      int32  `protobuf:"varint,4,opt,name=new_experience,json=newExperience,proto3" json:"new_experience,omitempty"`
...
func (x *PlayerExperienceChangeMessage) GetPreviousExperience() int32 {
	if x != nil {
...
func (x *PlayerExperienceChangeMessage) GetNewExperience() int32 {
	if x != nil {
...
var file_mc_player_messages_proto_rawDesc = []byte{
	...
	0x18, 0x03, 0x20, 0x01, 0x28, 0x05, 0x52, 0x12, 0x70, 0x72, 0x65, 0x76, 0x69, 0x6f, 0x75, 0x73,
	...
	0x28, 0x05, 0x52, 0x0d, 0x6e, 0x65, 0x77, 0x45, 0x78, 0x70, 0x65, 0x72, 0x69, 0x65, 0x6e, 0x63,
