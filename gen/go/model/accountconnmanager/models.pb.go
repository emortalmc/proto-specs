...
type ConnectionUser struct {
	...
	DiscordId *uint64 `protobuf:"varint,2,opt,name=discord_id,json=discordId,proto3,oneof" json:"discord_id,omitempty"`
	// github_id is a plain incremental integer
	GithubId *uint64 `protobuf:"varint,3,opt,name=github_id,json=githubId,proto3,oneof" json:"github_id,omitempty"`
}
...
func (x *ConnectionUser) GetDiscordId() uint64 {
...
func (x *ConnectionUser) GetGithubId() uint64 {
...
var file_account_conn_manager_models_proto_rawDesc = []byte{
	...
	0x18, 0x02, 0x20, 0x01, 0x28, 0x04, 0x48, 0x01, 0x52, 0x09, 0x64, 0x69, 0x73, 0x63, 0x6f, 0x72,
	0x64, 0x49, 0x64, 0x88, 0x01, 0x01, 0x12, 0x20, 0x0a, 0x09, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62,
	0x5f, 0x69, 0x64, 0x18, 0x03, 0x20, 0x01, 0x28, 0x04, 0x48, 0x02, 0x52, 0x08, 0x67, 0x69, 0x74,
