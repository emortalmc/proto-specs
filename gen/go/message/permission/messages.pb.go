...
const file_permission_messages_proto_rawDesc = "" +
	"\n" +
	"\x19permission/messages.proto\x12\x1aemortal.message.permission\x1a\x17permission/models.proto\"\xd4\x01\n" +
	"\x11RoleUpdateMessage\x12Y\n" +
	"\vchange_type\x18\x01 \x01(\x0e28.emortal.message.permission.RoleUpdateMessage.ChangeTypeR\n" +
	"changeType\x122\n" +
	"\x04role\x18\x03 \x01(\v2\x1e.emortal.model.permission.RoleR\x04role\"0\n" +
	"\n" +
	"ChangeType\x12\n" +
	"\n" +
	...
	"\n" +
	"\x06MODIFY\x10\x02\"\xd5\x01\n" +
	"\x18PlayerRolesUpdateMessage\x12`\n" +
	"\vchange_type\x18\x01 \x01(\x0e2?.emortal.message.permission.PlayerRolesUpdateMessage.ChangeTypeR\n" +
	"changeType\x12\x1b\n" +
	...
	"\n" +
	"\x06REMOVE\x10\x01Bb\n" +
	"\"dev.emortal.api.message.permissionP\x01Z:github.com/emortalmc/proto-specs/gen/go/message/permissionb\x06proto3"

var (
	file_permission_messages_proto_rawDescOnce sync.Once
	file_permission_messages_proto_rawDescData []byte
)

func file_permission_messages_proto_rawDescGZIP() []byte {
	file_permission_messages_proto_rawDescOnce.Do(func() {
		file_permission_messages_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_permission_messages_proto_rawDesc), len(file_permission_messages_proto_rawDesc)))
	})
...
func file_permission_messages_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_permission_messages_proto_rawDesc), len(file_permission_messages_proto_rawDesc)),
			NumEnums:      2,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
