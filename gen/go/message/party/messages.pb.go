...
type EventStartMessage struct {
	...
	Event *party.LiveEvent `protobuf:"bytes,1,opt,name=event,proto3" json:"event,omitempty"`
}
...
func (x *EventStartMessage) GetEvent() *party.LiveEvent {
	if x != nil {
		return x.Event
	}
	return nil
...
type EventDeleteMessage struct {
	...
	//
	//	*EventDeleteMessage_UpcomingEvent
	//	*EventDeleteMessage_LiveEvent
	Event isEventDeleteMessage_Event `protobuf_oneof:"event"`
}
...
func (m *EventDeleteMessage) GetEvent() isEventDeleteMessage_Event {
	if m != nil {
		return m.Event
	}
	return nil
...
func (x *EventDeleteMessage) GetUpcomingEvent() *party.EventData {
	if x, ok := x.GetEvent().(*EventDeleteMessage_UpcomingEvent); ok {
		return x.UpcomingEvent
	}
	return nil
}

func (x *EventDeleteMessage) GetLiveEvent() *party.LiveEvent {
	if x, ok := x.GetEvent().(*EventDeleteMessage_LiveEvent); ok {
		return x.LiveEvent
	}
	return nil
}

type isEventDeleteMessage_Event interface {
	isEventDeleteMessage_Event()
}

type EventDeleteMessage_UpcomingEvent struct {
	UpcomingEvent *party.EventData `protobuf:"bytes,1,opt,name=upcoming_event,json=upcomingEvent,proto3,oneof"`
}

type EventDeleteMessage_LiveEvent struct {
	LiveEvent *party.LiveEvent `protobuf:"bytes,2,opt,name=live_event,json=liveEvent,proto3,oneof"`
}

func (*EventDeleteMessage_UpcomingEvent) isEventDeleteMessage_Event() {}

func (*EventDeleteMessage_LiveEvent) isEventDeleteMessage_Event() {}
...
var file_party_messages_proto_rawDesc = []byte{
	...
	,
	...
	0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x2f, 0x70, 0x61, 0x72, 0x74, 0x79, 0x62, 0x06, 0x70,
...
var file_party_messages_proto_goTypes = []interface{}{
	...
	(*party.LiveEvent)(nil),             // 19: emortal.model.party.LiveEvent
}
var file_party_messages_proto_depIdxs = []int32{
	...
	19, // 11: emortal.message.party.EventStartMessage.event:type_name -> emortal.model.party.LiveEvent
	18, // 12: emortal.message.party.EventDeleteMessage.upcoming_event:type_name -> emortal.model.party.EventData
	19, // 13: emortal.message.party.EventDeleteMessage.live_event:type_name -> emortal.model.party.LiveEvent
...
func file_party_messages_proto_init() {
	...
	file_party_messages_proto_msgTypes[13].OneofWrappers = []interface{}{
		(*EventDeleteMessage_UpcomingEvent)(nil),
		(*EventDeleteMessage_LiveEvent)(nil),
	}
	type x struct{}
