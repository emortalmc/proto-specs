...
import com.google.protobuf.Message;import dev.emortal.api.message.accountconnmanager.AccountConnectedMessage;
...
public final class ProtoParserRegistry {
    ...
    private static void registerDefaults() {
        ...
        register(PartyBroadcastMessage.getDefaultInstance(), PartyBroadcastMessage::parseFrom, "party-manager");
        // Party - Events
